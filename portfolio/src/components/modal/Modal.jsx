...
const Modal = () => {
  ...
  return (
    <div className='w-lg rounded-md flex-col absolute justify-center items-center flex top-[70%] md:top-[70%] left-0 right-0 mx-auto my-auto z-200 bg-white w-[450px] p-4 pb-12 gap-4 '>
      <button
