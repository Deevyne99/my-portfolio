...
const Portfolio = () => {
  ...
  return (
    <section className='md:my-28 my-20 mx-8 md:mx-16 lg:mx-24'>
      <div className='flex flex-col justify-center items-center relative'>
        ...
        <article className='flex relative w-full overflow-hidden  mx-auto h-[425px] sm:h-[500px] md:h-[250px] bg-red-50'>
